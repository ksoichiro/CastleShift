...
- **Version**: 13.0.8 (1.21.1) / 9.2.14 (1.20.1)
- **Organization**: Architectury
- **License**: LGPL-3.0-only
- **URL**: https://github.com/architectury/architectury-api
- **License URL**: https://github.com/architectury/architectury-api/blob/1.21/LICENSE
...
### LGPL-3.0-only
Copyleft license similar to LGPL-2.1, updated to version 3. Linking to libraries licensed under LGPL-3.0 does not require the linking code to be licensed under LGPL-3.0.
...
- Runtime dependencies are not bundled with Castle Shift; users must install them separately
